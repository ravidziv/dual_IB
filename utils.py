...
def load_matrices2(num_of_layers, num_of_clusters, num_of_epochs, num_of_bins, num_of_noises):
    ...
    test_ity_clusterd_bound_nonlinear, test_ity_clusterd_names_nonlinear = build_tensorarray_with_names(num_of_layers, num_of_clusters, num_of_epochs, name=r"test_i_y_t_{}_{}_c_nonlinear")
    ...
    test_ixt_bound, test_ixt_bound_names = build_tensorarray_with_names(num_of_layers,[[1]*num_of_noises]*num_of_layers, num_of_epochs, name=r"test_i_x_t_{}_{}_nonlinear")
    test_ity_bound, test_ity_bound_name = build_tensorarray_with_names(num_of_layers,[[1]*num_of_noises]*num_of_layers, num_of_epochs, name=r"test_i_y_t_{}_{}_nonlinear")
